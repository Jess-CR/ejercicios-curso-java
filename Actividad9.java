import java.util.Scanner;
	...
	if(clave == 1){
		...
		if(antiguedad == 1){
			System.out.println("El empleado " + nombre + " perteneciente al departamento " + clave + " con " + antiguedad + " Tiene derecho a 6 dias");
		} else if(antiguedad >= 2 && antiguedad <= 6){
			System.out.println("El empleado " + nombre + "Tiene derecho a 14 dias");
		} else if (antiguedad >= 7){ 
			System.out.println("El empleado " + nombre + "Tiene derecho a 20 dias");
		} else {
			System.out.println("El empleado " + nombre + "Aun no tiene derecho a vacaciones");
		}
